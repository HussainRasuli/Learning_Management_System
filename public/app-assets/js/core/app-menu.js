        ...
        if ($body.data('menu') == 'vertical-menu-modern') {
          $('.modern-nav-toggle').find('.toggle-icon')
            .removeClass('feather icon-circle').addClass('feather icon-disc');
              ...
              $('.logo-mobile').addClass('logo');
              $('.navbar-header-mobile').addClass('navbar-header');
              $('.logo').removeClass('logo-mobile');
              $('.navbar-header').removeClass('navbar-header-mobile');
        ...
        if ($body.hasClass('menu-collapsed') && $body.data('menu') == 'vertical-menu-modern') {
          setTimeout(function () {
            if ($('.main-menu:hover').length === 0 && $('.navbar-header:hover').length === 0) {
              ...
              $('.logo-mobile').removeClass('logo');
              $('.navbar-header-mobile').removeClass('navbar-header');
