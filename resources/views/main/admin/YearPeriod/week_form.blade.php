    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="col-3">
                ...
                <a href="{{ route('yearPeriod_list') }}"><button type="button" class="btn btn-icon rounded-circle btn-primary mr-1 mb-1 float-right"><i class="feather icon-arrow-left"></i></button></a>
            </div>
        </div>
                            ...
                            <div class="row col-md-12">
                                <div class="col-md-4 col-12">
                                    <div class="form-label-group position-relative has-icon-left">
                                        <input type="text" class="form-control lm-input-text faculty" name="faculty" placeholder="Faculty Name" required>
                         ...
                         <div class='col-md-4 col-12'>\
                                <div class='form-label-group position-relative has-icon-left'>\
                                    <input type='text' class='form-control lm-input-text faculty_disable'\
                                        name='faculty' placeholder='Faculty Name' value='"+faculty+"' required disabled>\
                                        <div class='form-control-position'>\
                                            <i class='fa fa-university'></i>\
                                        </div>\
                                    <label for='first-name-floating-icon'>Faculty Name\
                            ...
                            <div class='col-md-4 col-12'>\
                                <div class='form-label-group position-relative has-icon-left'>\
                                    <input type='number' class='form-control lm-input-text'\
                                        name='dep_code[]' placeholder='Department Code' required>\
                                        <div class='form-control-position'>\
